...
//     public HittableOneSidedBlock(BoardEntity entity, Vector2Int direction, int hitMax = 1, int hitCount = 0) : base(entity, new Clearable(entity), new OneSidedBlockHitRule(), hitMax, hitCount)
//     {
