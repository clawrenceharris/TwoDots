...
public class ConnectionPresenter : MonoBehaviour
{
    ...
    private Stack<ConnectorLineView> _activeConnectionSegments = new();
    ...
    private void Start()
    {
        InputService.OnPointerDragged += OnPointerDragged;
        InputService.OnDotConnected += OnInputDotConnected;
        InputService.OnDotSelectionEnded += OnInputDotSelectionEnded;
        InputService.OnDotSelected += OnInputDotSelected;
    }
