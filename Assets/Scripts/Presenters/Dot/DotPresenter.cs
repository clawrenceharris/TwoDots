...
public class DotPresenter : IDotPresenter
{
    ...
    private Dictionary<Type, IDotPresenter> _presenters = new();
    ...
    public void Drop(int row)
    {
        ...
        _view.transform.DOMoveY(row * BoardView.TileSize, 0.5f).SetEase(Ease.OutBounce).OnComplete(() =>
        {
    ...
    public void PrepareForDrop()
    {
        ...
        _view.transform.position = new Vector3(worldPos.x, (Camera.main.orthographicSize * 2) + worldPos.y, 0);
    }
